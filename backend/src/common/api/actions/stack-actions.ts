...
export interface StackActions {
   ...
   */
  stackCombine(destinationId: Stack['id'], sourceId: Stack['id']): Stack;
   ...
   */
  stackDivide(stackId: Stack['id'], length: number): DivideResponse;
   ...
   */
  stackFlip(stackId: Stack['id'], faceUp: boolean): Stack;
   ...
   */
  stackPush(stackId: Stack['id'], tokenId: Token['id'], toTop?: boolean, index?: number): Stack;
   ...
   * @param index Index where the token will be added, 0 by default
   */
  stackPull(stackId: Stack['id'], fromTop?: boolean, index?: number): PullResponse;
}
